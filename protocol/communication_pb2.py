...
_NOISECONTRIBUTION = _descriptor.Descriptor(
  name='NoiseContribution',
  full_name='NoiseContribution',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='contributor_id', full_name='NoiseContribution.contributor_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='target_id', full_name='NoiseContribution.target_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='contribution', full_name='NoiseContribution.contribution', index=2,
...
_SHOULDDECRYPTREQUEST = _descriptor.Descriptor(
  name='ShouldDecryptRequest',
  full_name='ShouldDecryptRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='client_id', full_name='ShouldDecryptRequest.client_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SHOULDDECRYPTRESPONSE = _descriptor.Descriptor(
  name='ShouldDecryptResponse',
  full_name='ShouldDecryptResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='contribute', full_name='ShouldDecryptResponse.contribute', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='model', full_name='ShouldDecryptResponse.model', index=1,
...
_SHOULDDECRYPTRESPONSE.fields_by_name['model'].message_type = _MODEL
...
DESCRIPTOR.message_types_by_name['ShouldDecryptRequest'] = _SHOULDDECRYPTREQUEST
DESCRIPTOR.message_types_by_name['ShouldDecryptResponse'] = _SHOULDDECRYPTRESPONSE
...
NoiseContribution = _reflection.GeneratedProtocolMessageType('NoiseContribution', (_message.Message,), {
  ...
  '__module__' : 'protocol.communication_pb2'
  # @@protoc_insertion_point(class_scope:NoiseContribution)
  })
_sym_db.RegisterMessage(NoiseContribution)
...
ShouldDecryptRequest = _reflection.GeneratedProtocolMessageType('ShouldDecryptRequest', (_message.Message,), {
  'DESCRIPTOR' : _SHOULDDECRYPTREQUEST,
  '__module__' : 'protocol.communication_pb2'
  # @@protoc_insertion_point(class_scope:ShouldDecryptRequest)
  })
_sym_db.RegisterMessage(ShouldDecryptRequest)

ShouldDecryptResponse = _reflection.GeneratedProtocolMessageType('ShouldDecryptResponse', (_message.Message,), {
  'DESCRIPTOR' : _SHOULDDECRYPTRESPONSE,
  '__module__' : 'protocol.communication_pb2'
  # @@protoc_insertion_point(class_scope:ShouldDecryptResponse)
  })
_sym_db.RegisterMessage(ShouldDecryptResponse)
...
_SERVER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='TpShouldPartialDecrypt',
    full_name='Server.TpShouldPartialDecrypt',
    index=5,
    containing_service=None,
    input_type=_SHOULDDECRYPTREQUEST,
    output_type=_SHOULDDECRYPTRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='TpPartialDecrypt',
    full_name='Server.TpPartialDecrypt',
    index=6,
    containing_service=None,
    input_type=_COMMITUPDATEREQUEST,
    output_type=_ACK,
